...
function FindTeacherByID(props){
           ...
           <div className="h-100 bg-[#737373] rounded-t-md border-2 border-black pt-10 pb-10 px-5">
              <div>
                 ...
                 <div className=" bg-[#D9D9D9] rounded-md border-2 border-black mt-20 mx-96">
                   <div> {props.alert}:  <input className="mx-4 my-3 rounded-md border-black border-2 placeholder:text-[#737373] text-center"  placeholder="ID PROFESOR" id="idprofesor" 
                              onChange={( event )=>{ 
